...
# Function to warm start the policy
warm_start() {
    echo '["claude-prediction-online", "prediction-online", "prediction-online-sme"]' >| sudo tee "$PWD/../$store/available_tools_store.json"
    echo '{"counts": [16, 33, 54], "eps": 0.1, "rewards": [-0.06394516434480157, -0.5935249657470777, 0.507192767958923]}' >| sudo tee "$PWD/../$store/policy_store.json"
    echo '{}' >| sudo tee ".trader_runner/utilized_tools.json"
}
...
export BET_KELLY_FRACTION=0.01
export SAMPLE_BETS_CLOSING_DAYS=2
